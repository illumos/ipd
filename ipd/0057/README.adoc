...
* https://github.com/rmustacc/illumos-gate/blob/i2c-dev/usr/src/uts/common/io/i2c/dev/eeprom/spd511x/spd511x.c[SPD5118
EEPROM and Sensor Driver (DDR5 Hub)]
* https://github.com/rmustacc/illumos-gate/blob/i2c-dev/usr/src/uts/common/io/i2c/dev/sensor/ts511x/ts511x.c[TX511x
and TS521x Temp Sensor (DDR5)]
* https://github.com/rmustacc/illumos-gate/blob/i2c-dev/usr/src/uts/common/io/i2c/dev/sensor/lm7x/lm7x.c[LM75,
LM76, and LM77 temp sensor]
* https://github.com/rmustacc/illumos-gate/blob/i2c-dev/usr/src/uts/common/io/i2c/dev/sensor/tmp43x/tmp43x.c[TMP401,
