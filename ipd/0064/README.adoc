...
. There may be benefit to implementing the path search required for
  the `posix_spawnp(3C)` variant in the kernel rather than libc.
  Benchmarking during development will help inform here.
